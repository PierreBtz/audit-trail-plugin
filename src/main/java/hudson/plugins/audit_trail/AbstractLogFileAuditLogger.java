...
public abstract class AbstractLogFileAuditLogger extends AuditLogger {
    ...
    AbstractLogFileAuditLogger(String log, int count, String logSeparator) {
    ...
    public void log(String event) {
        ...
        getHandler().publish(new LogRecord(CONFIG, event));
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!Objects.equals(log, that.log)) return false;
    ...
    abstract FileHandler createFileHandler() throws IOException;
